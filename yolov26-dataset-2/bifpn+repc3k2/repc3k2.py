...
class RepConv(nn.Module):
    """
    Eğitim sırasında 3x3 + 1x1 + identity branch kullanır.
    Bu versiyon fuse/deploy içermeyen güvenli eğitim iskeletidir.
    """
...
class RepC3k2(nn.Module):
    ...
    def __init__(self, c, n=1, shortcut=True, e=0.5):
        ...
        self.m = nn.Sequential(
            *(RepBottleneck(c_, shortcut=shortcut) for _ in range(n))
        )
